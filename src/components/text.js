    ...
    <div>
      <div className="grid grid-rows-2 min-h-screen overflow-y-auto relative">
        ...
        <div
          ...
          style={{
            backgroundImage:
              'url("https://www.shrinatarajan.com/wp-content/uploads/2023/10/bharatnatyam-shrinatarajan.jpg")',
          }}
        >
            ...
            <div className="text-center">
              ...
              >
                <div className="justify-center border-white p-4 md:p-6">
                  <button className="text-black hover:cursor-pointer" onClick={handleAboutClick}>About Instructor</button>
                </div>
              </motion.div>
            </div>
          </div>
        ...
        <div className="bg-black shadow-2xl ">
         ...
         <div className="text-white shadow-2xl shadow-red-400">
          hj,jbjh
          </div>
        </div>
